...
For a guided credential-first flow, use:

- [Bootstrap Installer Quickstart](./bootstrap-installer-quickstart.md)
- [Bootstrap Installer Troubleshooting](./bootstrap-installer-troubleshooting.md)
- [Migrating from Legacy Installers](./bootstrap-installer-migration.md)
