...
SKILL_MANAGE_SCHEMA = {
    "name": "skill_manage",
    "description": f"Create, patch, edit, delete, and maintain skills under {display_hermes_home()}/skills/.",
    "parameters": {
        "type": "object",
        "properties": {
            "action": {
            ...
            "old_string": {
                "type": "string",
                "description": (
                    "Text to find for patch. Must be unique unless replace_all=true."
                )
            },
            "new_string": {
                "type": "string",
                "description": (
                    "Replacement text for patch (empty string allowed)."
                )
            },
            "replace_all": {
                "type": "boolean",
                "description": "For patch: replace all matches (default: false)."
            },
            "category": {
                "type": "string",
                "description": (
                    "Optional category for create."
                )
            },
            "file_path": {
                "type": "string",
                "description": (
                    "Supporting file path in skill directory."
                )
            },
            "file_content": {
                "type": "string",
            ...
            "absorbed_into": {
                "type": "string",
                "description": (
                    "For delete: target umbrella skill name, or empty string for prune."
                )
            },
        },
